...
<head>
	...
	<title><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?>微体验 - 公众平台自助引擎<?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
		...
		<div class="login-body">
			<div class="login-title"></div>
				...
				<div class="login-subtitle">
					还没有WTIYAN营销帐号?立刻 <a href="<?php  echo url('user/register');?>">创建一个帐号</a>
				</div>
			</form>
		</div>
		<div class="login-footer">
			<div class="pull-left">
				&copy; 2015 WTIYAN.COM
			</div>
