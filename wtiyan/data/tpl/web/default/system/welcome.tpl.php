...
<div class="page-container page-navigation-top-fixed">
    ...
    <div class="page-content" style="margin-left: 223px;">
        ...
        <ul class="x-navigation x-navigation-horizontal" style="padding-right: 220px;z-index: 8;position: fixed;">
            ...
            <a href="<?php  echo url('home/welcome/ext');?>"><i class="fontello-icon-cog-alt"></i> 继续管理公众号（<?php  echo $_W['account']['name'];?>）</a>
            </li>
        ...
        <div class="page-content-wrap" style="max-width: none"><?php  } ?>
	...
	<div class="row" style="margin-bottom:5em;">
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('cloud/upgrade');?>" class="tile tile-primary">
                <i class="fontello-icon-arrows-ccw" style="font-size: 30px; line-height: normal; "></i>
                <p>一键更新</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('cloud/profile');?>" class="tile tile-primary">
                <i class="fontello-icon-edit-2" style="font-size: 30px; line-height: normal; "></i>
                <p>注册站点</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('cloud/diagnose');?>" class="tile tile-primary">
                <i class="fontello-icon-user-md" style="font-size: 30px; line-height: normal; "></i>
                <p>云服务诊断</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/site');?>" class="tile tile-primary">
                <i class="fontello-icon-wrench-2" style="font-size: 30px; line-height: normal; "></i>
                <p>站点设置</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/common');?>" class="tile tile-primary">
                <i class="fontello-icon-cog-alt" style="font-size: 30px; line-height: normal; "></i>
                <p>其他设置</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('cloud/appstore');?>" class="tile tile-primary">
                <i class="fontello-icon-basket-2" style="font-size: 30px; line-height: normal; "></i>
                <p>应用商城</p>
                <div class="informer informer-default dir-tr"><span class="fo fontello-icon-basket-2"></span></div>
            </a>
        </div>
		<div class="col-md-mm" style="float: left; min-width: 120px;">
		<a href="<?php  echo url('cloud/addons');?>"  class="tile tile-primary">
				<i class="fontello-icon-basket-2" style="font-size: 30px; line-height: normal; "></i>			
				<p>商城切换</p>
		<div class="informer informer-default dir-tr"><span class="fo fontello-icon-basket-2"></span></div>
			</a>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('extension/module');?>" class="tile tile-primary">
                <i class="fontello-icon-flag-sw" style="font-size: 30px; line-height: normal; "></i>
                <p>模块管理</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('extension/service/display');?>" class="tile tile-primary">
                <i class="fontello-icon-link-3" style="font-size: 30px; line-height: normal; "></i>
                <p>常用服务</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('extension/theme');?>" class="tile tile-primary">
                <i class="fontello-icon-signal-3" style="font-size: 30px; line-height: normal; "></i>
                <p>微站风格</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('extension/theme/web');?>" class="tile tile-primary">
                <i class="fontello-icon-smashing" style="font-size: 30px; line-height: normal; "></i>
                <p>后台皮肤</p>
                <div class="informer informer-default dir-tr"><span class="fo fontello-icon-smashing"></span></div>
            </a>
        </div>
                <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('extension/platform');?>" class="tile tile-primary">
                <i class=" fontello-icon-chat-empty" style="font-size: 30px; line-height: normal; "></i>
                <p>微信开放平台</p>
                <div class="informer informer-default dir-tr"><span class="fo fontello-icon-chat-empty"></span></div>
            </a>
        </div>
<!--         <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('extension/menu');?>" class="tile tile-primary">
                <i class="fontello-icon-list-numbered-1" style="font-size: 30px; line-height: normal; "></i>
                <p>系统菜单</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('account/display');?>" class="tile tile-primary">
                <i class=" fontello-icon-list-bullet" style="font-size: 30px; line-height: normal; "></i>
                <p>公众号列表</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('account/batch');?>" class="tile tile-primary">
                <i class="fontello-icon-wrench-1" style="font-size: 30px; line-height: normal; "></i>
                <p>批量操作</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('user/profile');?>" class="tile tile-primary">
                <i class="fontello-icon-briefcase" style="font-size: 30px; line-height: normal; "></i>
                <p>我的账户</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('user/display');?>" class="tile tile-primary">
                <i class="fontello-icon-users" style="font-size: 30px; line-height: normal; "></i>
                <p>用户管理</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('user/group');?>" class="tile tile-primary">
                <i class="fontello-icon-th-4" style="font-size: 30px; line-height: normal; "></i>
                <p>用户组管理</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('user/registerset');?>" class="tile tile-primary">
                <i class="fontello-icon-cog-4" style="font-size: 30px; line-height: normal; "></i>
                <p>用户设置</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/updatecache');?>" class="tile tile-primary">
                <i class="fontello-icon-arrows-cw-2" style="font-size: 30px; line-height: normal; "></i>
                <p>更新缓存</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/database');?>" class="tile tile-primary">
                <i class="fontello-icon-database" style="font-size: 30px; line-height: normal; "></i>
                <p>数据库</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/tools');?>" class="tile tile-primary">
                <i class="fontello-icon-wrench" style="font-size: 30px; line-height: normal; "></i>
                <p>检测工具</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/sysinfo');?>" class="tile tile-primary">
                <i class="fontello-icon-doc-text" style="font-size: 30px; line-height: normal; "></i>
                <p>系统信息</p>
        ...
        <div class="col-md-mm" style="float: left; min-width: 120px;">
            <a href="<?php  echo url('system/logs');?>" class="tile tile-primary">
                <i class="fontello-icon-list-alt" style="font-size: 30px; line-height: normal; "></i>
                <p>查看日志</p>
