...
<div class="account">
	...
	<div class="panel panel-default row">
		<div class="panel-body">
			<div class="col-sm-3 profile" style="  width: auto;
  background: none;
  float: left;
  padding: 15px 10px;">
			<a href="###" class="profile-image">
				<img src="<?php  echo $_W['attachurl'];?>headimg_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>" alt="<?php  echo $account['name'];?>" class= onerror="this.src='resource/images/gw-wx.gif'" ></a>
			</div>
			<div class="col-sm-7">
