<?php defined('IN_IA') or exit('Access Denied');?><style>
	...
	.home-container .tile{float:left; display:block; text-decoration:none; outline:none; width:6em; height:6em; margin:.4em;-webkit-box-shadow:none; box-shadow: none;}
	...
	.modal-dialog{width:330px !important;}
</style>
				...
				<td>
					<div class="home-container">
						...
						<a href="javascript:viod(0);" class="tile text-center btn btn-default">
							...
							<i style="display: block;color: #333;height: 1em;overflow: hidden;font-size: 2em;margin: .25em .2em;line-height: 43px;"></i>
							<?php  } else { ?>
							<i class="fa <?php  echo $nav['css']['icon']['icon'];?>" style="display: block;color: #333;height: 1em;overflow: hidden;font-size: 2em;margin: .25em .2em;line-height: 43px;"></i>
							<?php  } ?>
							<span style="<?php  echo $nav['css']['name'];?>; color:#333" title="<?php  echo $nav['name'];?>" ><?php  echo $nav['name'];?></span>
						</a>
						<?php  } } ?>
					</div>
				</td>
