	...
	<div class="col-md-12">
		...
		<form action="./index.php" method="get" role="form" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-8 mobile500"  style="margin-top: 10px; padding-right: 15px;">
				...
				<div class="panell panel-default" style="margin-bottom: 0px;">
					<div class="panel-heading ui-draggable-handle">
						<div class="row" style="font-size:12px; line-height:19px; color:#666; font-weight: bold;">
							<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mobile500">主公众号名称：<span><?php  echo $uni['name'];?></span></div>
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 edit-group mobile500">服务套餐：<span  id="<?php  echo $uni['group']['id'];?>"><?php  echo $uni['group']['name'];?></span> <i class="fa fa-pencil" id="<?php  echo $uni['uniacid'];?>" style="cursor:pointer"></i></div>
					...
					<ul class="panel-body list-group ">
						...
						<li class=" row list-group-item" style="line-height:50px; border:none;padding: 0px 15px;">
							...
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-4 item colmobile11" style="width: 41.6%;">
							<img <?php  if(file_exists(IA_ROOT . '/attachment/headimg_'.$account['acid'].'.jpg')) { ?> src="<?php  echo $_W['attachurl'];?>headimg_<?php  echo $account['acid'];?>.jpg?acid=<?php  echo $account['acid'];?>"<?php  } else if($account['type'] == '1') { ?>src="<?php  echo $_W['attachurl'];?>headimg_7.jpg"<?php  } else { ?>src="<?php  echo $_W['attachurl'];?>headimg_yixin.jpg"<?php  } ?> class="" width="40" height="40" style="border-radius: 50%;
								margin-right: 31px;
								...
								<span class="label label-default"><?php  echo $types[$account['type']]['title'];?></span>
								<?php  echo $account['name'];?>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 item mobile500" style="width: 24.333333%;">
							...
							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-right colmobile" style="padding-bottom:5px;">
