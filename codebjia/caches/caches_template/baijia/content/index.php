...
<link href="<?php echo CSS_PATH;?>mnbj/mnbj-main.css" rel="stylesheet" type="text/css" />
<link href="<?php echo CSS_PATH;?>mnbj/mnbj-index.css" rel="stylesheet" type="text/css" />
...
<span><script type="text/javascript">document.write('<iframe src="<?php echo APP_PATH;?>index.php?m=member&c=index&a=mini&forward='+encodeURIComponent(location.href)+'&siteid=<?php echo get_siteid();?>" allowTransparency="true"  width="500" height="24" frameborder="0" scrolling="no"></iframe>')</script></span>

<a target="_top" href="<?php echo siteurl($siteid);?>/">码农百家</a> 
<!--|  <a target="_top" href="#">下载</a> -->
</div>

<div class="daoh1">
<a target="_top" href="http://www.chinaunix.net/" class="logo" title="ChinaUnix.net"></a>
<form id="topSearchBar" action="http://bbs.chinaunix.net/search.php?mod=forum" method="get" accept-charset="GBK" onsubmit="document.charset='GBK';">
<input name="mod" value="forum" type="hidden">
    <input name="source" value="domain" type="hidden">
<div class="l">
<div class="inp1"><input value="" name="q" id="q" type="text"></div><input value="" class="btn1" onclick="return c_search(this.form,0);" type="submit">
</div>
<div class="r"><a target="_top" href="http://bbs.chinaunix.net/search.php?mod=forum">高级搜索</a></div>
</form> 
</div>

<div class="daoh2">
<li class="li1"><a href="http://www.chinaunix.net/" target="_self" class="here">首页</a></li>
<li class="li3"><a href="http://www.chinaunix.net/ops/" target="_self">自动化运维</a></li>
<li><a href="http://www.chinaunix.net/virtual/" target="_self">虚拟化</a></li>
<li><a href="http://www.chinaunix.net/server/" target="_self">服务器</a></li>
<li class="li2"><a href="http://www.chinaunix.net/stor/" target="_self">存储备份</a></li>
<li><a href="http://www.chinaunix.net/cpp/" target="_self">C/C++</a></li>
<li class="li1"><a href="http://www.chinaunix.net/php/" target="_self">PHP</a></li>
<li><a href="http://www.chinaunix.net/mysql/" target="_self">MySQL</a></li>
<li><a href="http://www.chinaunix.net/embedded/" target="_self">嵌入式</a></li>
<li class="li3"><a href="http://www.chinaunix.net/linux/" target="_self">Linux系统</a></li>
<li class="li3  li0"><a href="http://www.chinaunix.net/talk" target="_self">大话IT</a></li>
</div>
<!--main-->
<div class="main">
	<div class="col-left">
