...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>码农百家 <?php echo PC_VERSION?> <?php echo PC_RELEASE?><br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_product_site')?><a href="http://www.mnbaijia.com/" target="_blank">http://www.mnbaijia.com/</a> <br />
	</div>
</div>
